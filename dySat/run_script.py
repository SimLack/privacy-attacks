...
# my params: graph1 (and graph2 if retrain) as well as save direction for temporal graphs
parser.add_argument('--save_graphs_embs_in', type=str, nargs='?', default="", help='graph and embs save dir')
parser.add_argument('--graph1', type=str, nargs='?', default="", help='firstGraph')
parser.add_argument('--graph2', type=str, nargs='?', default="", help='secondGraph')
...
parser.add_argument('--val_freq', type=int, nargs='?', default=1, #usually 1
                    help='Validation frequency (in epochs)')

parser.add_argument('--test_freq', type=int, nargs='?', default=1, #usually 1
...
for t in range(args.min_time, args.max_time + 1):
    commands.append(' '.join(
        ["python", train_file, "--time_steps", str(t), "--base_model", args.base_model, "--model", args.model,
         "--dataset", args.dataset,"--save_graphs_embs_in", args.save_graphs_embs_in]))
